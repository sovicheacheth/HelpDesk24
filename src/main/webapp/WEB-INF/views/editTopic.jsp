	...
	<div class="col-lg-6 col-lg-offset-3">
		<div class="well">
			<div class="container">
				<div class="row">
					<div class="col-lg-6">								
<h3 align="center">Edit Topic : ${topic.id}</h3>
       
                   
                <form action="editTopic" method="post" class="bs-example form-horizontal">                  
    ...
    <input type="hidden" name ="id" value="${topic.id}">     
          <button  class="btn btn-warning">update topic</button>   
