	...
	<div class="col-lg-6 col-lg-offset-3">
		<div class="well">
			<div class="container">
				<div class="row">
					<div class="col-lg-6">								
<h3 align="center">Edit Ticket : ${ticket.id}</h3>
       
                   
                <form action="editTicket" method="post" class="bs-example form-horizontal">                  
  ...
  <select name="topic"class="form-control">
    ...
    <input type="hidden" name ="id" value="${ticket.id}">     
          <button  class="btn btn-warning">update Ticket</button>   
